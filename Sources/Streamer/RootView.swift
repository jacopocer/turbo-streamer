...
struct RootView: View {
    ...
    @StateObject private var updater = Updater(appKey: "streamer", appBundleName: "Turbo Streamer.app")
    @AppStorage("TurboStreamer.didOnboard") private var didOnboard = false
    ...
    var body: some View {
        ...
        .sheet(isPresented: $showOnboard) {
            OnboardingView(net: manager.turboNet, appTitle: "Turbo Streamer",
                           blurb: "Send one high-quality, low-latency stream to a Turbo Receiver, and on to your platforms.") {
